    ...
    public static void main(String[] args) {
         try {
            ...
            while (newIndividual.getFitness() >= 20) {
                ...
                writeStartGen("C:\\Users\\Admin\\Desktop\\vscode_java\\DE_Sensor-main\\result\\gen.out");

                File benchmarkFile = new File("C:\\Users\\Admin\\Desktop\\vscode_java\\Out\\resultDE.csv");
                ...
                while (generation >= 0) {
                    ...
                    for (int i = 0; i < populationSize; i++) {
                        ...
                        crossed = de.crossover(target, crossed);
                        }
                    ...
                    writeGeneration("C:\\Users\\Admin\\Desktop\\vscode_java\\DE_Sensor-main\\result\\genDE.out", generation, bestIndividual.getFitness());
                ...
                writeResult("C:\\Users\\Admin\\Desktop\\vscode_java\\DE_Sensor-main\\result\\result.out", maxFitness);
                bench.close();
                int k = 0;
                ...
                writeGeneration("C:\\Users\\Admin\\Desktop\\vscode_java\\DE_Sensor-main\\result\\timeDE.out", nTime, time);
            }
